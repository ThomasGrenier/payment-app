...
export const en: Record<TranslationKey, string> = {
  ...
  "Payment.details.created": "Bought on {{date}}",
  ...
  "Payment.plan.state.late": "Late",
  "Payment.plan.state.paid": "Paid",
  "Payment.plan.state.pending": "Pending",
  "Payment.plan.title": "Installments",
  "Payment.state.completed": "Completed",
  "Payment.state.default": "All",
